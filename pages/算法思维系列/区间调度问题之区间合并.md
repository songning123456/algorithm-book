...
![title](../../images/mergeInterval/title.png)
...
![1](../../images/mergeInterval/1.jpg)

**显然，对于几个相交区间合并后的结果区间 `x`，`x.start` 一定是这些相交区间中 `start` 最小的，`x.end` 一定是这些相交区间中 `end` 最大的。**

![2](../../images/mergeInterval/2.jpg)
...
[上一篇：FloodFill算法详解及应用](FloodFill算法详解及应用.md)

[下一篇：区间调度之区间交集问题](区间交集问题.md)
